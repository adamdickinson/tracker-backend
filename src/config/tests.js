...
export default deepFreeze([
  ...
  { 
    ...
    specs:      [
      { id: "standingVerticalLeap", name: "Standing Vertical Leap", metric: "CM_FT" },
      { id: "maxVerticalLeap",      name: "Max Vertical Leap",      metric: "CM_FT" },
    ],
    groupTest:  false,
  },
  { 
    ...
    resultType: "MEASUREMENTS",
    specs:      [
      { id: "height",          name: "Height",              metric: "CM_FT" },
      { id: "heightWithShoes", name: "Height (with shoes)", metric: "CM_FT" },
      { id: "weight",          name: "Weight",              metric: "KG_LB" },
      { id: "wingspan",        name: "Wingspan",            metric: "CM_FT" },
      { id: "standingReach",   name: "Standing Reach",      metric: "CM_IN" },
      { id: "bodyFat",         name: "Body Fat",            metric: "PERCENTAGE" },
      { id: "handLength",      name: "Hand Length",         metric: "CM_IN" },
      { id: "handWidth",       name: "Hand Width",          metric: "CM_IN" },
    ],
    groupTest:  false,
  },
  { 
