...
exports.recordSplitResult = exports.splitResult = void 0;
...
const recordSplitResult = async ({
  result
}) => {
  const _id = `SplitResult:${(0, _v.default)()}`;
...
exports.recordSplitResult = recordSplitResult;